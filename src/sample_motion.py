...
def generation(model, cfg):
    ...
    save_path = pjoin(cfg.save_path, "gen_joints/generated")
    os.makedirs(save_path, exist_ok=True)
    
    texts = [cfg.text] * cfg.repeats
    decomposed = [cfg.decomposed_text] * cfg.repeats
