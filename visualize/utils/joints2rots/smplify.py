...
def guess_init_3d(model_joints, 
    ...
    # print(model_joints.shape, j3d.shape)
    ...
    # print(joints_ind_category)
    # print(j3d[:, joints_ind_category].shape, model_joints[:, gt_joints_ind].shape)
...
class SMPLify3D():
    ...
    def __call__(self, init_pose, init_betas, init_cam_t, j3d, conf_3d=1.0, seq_ind=0):
        ...
        # print(model_joints.device, j3d.device, self.joints_category)
